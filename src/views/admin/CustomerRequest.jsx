...
import { get_customer_request } from '../../store/Reducers/customerReducer';
...
const CustomerRequest = () => {
    ...
    return (
      ...
      <h1 className='text-[20px] font-bold mb-3'>  Customer Request </h1>
    ...
    <table className='w-full text-sm text-left text-[#000000]'>
        ...
        <tbody>
            {
                customers.map((d, i) => <tr className='border-b border-slate-700' key={i}>
                ...
                <td scope='row' className='py-2 px-4 font-medium whitespace-nowrap'>
                    <span>{d.phoneNumber}</span> </td>

               <td scope='row' className='py-2 px-4 font-medium whitespace-nowrap'>
                    <span>{d.gender}</span> </td>
                 
                 
                <td scope='row' className='py-2 px-4 font-medium whitespace-nowrap'>
                    <div className='flex justify-start items-center gap-4'>
                    <Link to={`/admin/dashboard/customer/details/${d._id}`} className='p-[6px] bg-green-500 rounded hover:shadow-lg hover:shadow-green-500/50'> <FaEye /> </Link> 
