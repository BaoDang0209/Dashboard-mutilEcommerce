    ...
    return (
        ...
        <div className='w-full p-4 bg-[#b1addf] rounded-md'>
            <div className='flex justify-between items-center p-4'>
                ...
                <select onChange={status_update} value={status} name="" id="" className='px-4 py-2 focus:border-indigo-500 outline-none bg-[#475569] border border-slate-700 rounded-md text-[#000000]'>
