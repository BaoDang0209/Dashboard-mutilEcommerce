...
const Category = () => {
  ...
  /// Handle Edit Button 
    ...
    return (
        ...
        <div className='flex lg:hidden justify-between items-center mb-5 p-4 bg-[#b1addf] rounded-md'>
            <h1 className='text-[#000000] font-semibold text-lg'>Category</h1>
   ...
   <div className='relative overflow-x-auto'>
    ...
    <div className='w-full pl-5'>
        <div className='bg-[#b1addf] h-screen lg:h-auto px-3 py-2 lg:rounded-md text-[#000000]'>
            ...
            <form onSubmit={addOrUpdateCategory}>
                <div className='flex flex-col w-full gap-1 mb-3'>
                 ...
                 <div>
                    <label className='flex justify-center items-center flex-col h-[238px] cursor-pointer border border-dashed hover:border-red-500 w-full border-[#000000]'  htmlFor="image">
                        {
